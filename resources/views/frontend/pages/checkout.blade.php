                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod"> <label> (COD) Cash On Delivery</label><br>
                                                <input name="payment_method"  type="radio" value="paypal"> <label> Digital Wallet</label> 
                                            </form-group>
